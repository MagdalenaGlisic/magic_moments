...
var c=k.createElement("p");c.textContent=themifyBuilder.i18n.no_op_module;a.appendChild(c);b.appendChild(a);return b}if("tabs"===a.type)b.appendChild(this.tabs.render(a,this));else for(c in a){if(!0===a[c].hide||void 0===a[c].type)continue;var d=a[c].type;let f=this[d].render(a[c],this);if("separator"!==d&&"expand"!==d&&"group"!==d){var e=a[c].id?a[c].id:a[c].topId;"tabs"!==d&&"multi"!==d&&e&&("styling"===this.clicked?("visual"===l.mode&&void 0!==a[c].prop&&(this.styles[e]=q.extend(!0,{},a[c])),this.stylesData[e]=
q.extend(!0,{},a[c])):"visual"===l.mode&&"setting"===this.clicked&&null!==this.values&&void 0!==this.values[e]&&!0!==this.is_repeat&&(this.settings[e]=this.values[a[c].id],void 0!==a[c].units&&void 0!==this.values[e+"_unit"]&&(this.settings[e+"_unit"]=this.values[e+"_unit"])));if("builder"!==d){let g=k.createElement("div");g.className="tb_field";void 0===a[c].dc||a[c].dc||(g.className+=" tb_disable_dc");g.setAttribute("data-type",d);void 0!==e&&(g.className+=" "+e);void 0!==a[c].wrap_class&&(g.className+=
" "+a[c].wrap_class);"custom_css"===d?g.appendChild(this.separator.render(a[c],this)):"toggle_switch"===d?g.className+=" switch-wrapper":"slider"===d?g.className+=" tb_slider_options":"message"===d&&void 0!==a[c].hideIf&&new Function("return "+a[c].hideIf)?g.className+=" tb_hide_option":void 0!==a[c].required&&"setting"===this.clicked&&(e=void 0!==a[c].required.message?a[c].required.message:themifyBuilder.i18n.not_empty,g.setAttribute("data-validation",void 0!==a[c].required.rule?a[c].required.rule:
"not_empty"),g.setAttribute("data-error-msg",e),g.className+=" tb_must_validate");"styling"===this.clicked&&!1===a[c].is_responsive&&(g.className+=" responsive_disable");e=this.getTitle(a[c]);if(!1!==e){e=e.trim();let b=k.createElement("div"),m=k.createElement("span");b.className="tb_label";m.className="tb_label_text";m.textContent=e;b.appendChild(m);""===e&&(b.className+=" tb_empty_label");void 0!==a[c].help&&""!==a[c].label&&(b.classList.add("contains-help"),m.appendChild(this.help(a[c].help)));
g.appendChild(b);"multi"!==d?(d=k.createElement("div"),d.className="tb_input",d.appendChild(f),g.appendChild(d)):g.appendChild(f)}else g.appendChild(f);b.appendChild(g)}else b.appendChild(f)}else b.appendChild(f)}return b},tabs:{click:0,render(a,b){const c=a.options,d=k.createDocumentFragment(),e=k.createElement("ul"),f="styling"===b.clicked&&0===this.click&&"module"===b.component?k.createElement("div"):null,g=k.createElement("div"),h=void 0!==a.isRadio;let m=null,p=null;g.className="tb_tabs";e.className=
"clearfix tb_tab_wrapper";++this.click;!0===h&&(void 0!==b.values[a.id]&&""!==b.values[a.id]&&(p=!0,m=b.values[a.id]),e.className+=" tb_radio_input_container",!0===b.is_repeat?(e.className+=!0===b.is_sort?" tb_lb_sort_child":" tb_lb_option_child",e.dataset.inputId=a.id):(e.className+=" tb_lb_option",e.id=a.id));for(let f in c){let g=k.createElement("li"),n=!0===h?k.createElement("label"):k.createElement("a"),l=k.createElement("div"),y="tb_"+this.click+"_"+f;l.id=y;l.className="tb_tab";n.textContent=
void 0!==c[f].label?c[f].label:b.label[f];if(!0===h){let b=k.createElement("input");b.type="radio";b.className="tb_radio_tab_input";b.name=a.id;if(m===f||m==="tb_"+f)b.checked=!0;b.value=f;n.setAttribute("href","#"+y);n.className="tb_radio_tab_label";n.appendChild(b)}else n.href="#"+y;null===p||m===f||m==="tb_"+f?(p=!0,g.className="current",l.appendChild(b.create(c[f].options)),l.style.display="block"):l.addEventListener("themify_builder_tabsactive",function(){this.appendChild(b.create(c[f].options));
"setting"===b.clicked&&b.setUpEditors();b.callbacks()},{once:!0,passive:!0});n.addEventListener("click",b.switchTabs);g.appendChild(n);e.appendChild(g);d.appendChild(l)}null!==f?(f.className="tb_styling_tab_nav",f.appendChild(e),g.appendChild(f)):g.appendChild(e);g.appendChild(d);setTimeout(b.callbacks.bind(b),5);return g}},group:{render(a,b){const c=k.createElement("div");void 0!==a.wrap_class&&(c.className+=" "+a.wrap_class);c.appendChild(b.create(a.options));return c}},builder:{render(a,b){b.is_repeat=
!0;const c=k.createElement("div"),d=k.createElement("a"),e=this;c.className="tb_row_js_wrapper tb_lb_option";void 0!==a.wrap_class&&(c.className+=" "+a.wrap_class);c.id=a.id;d.className="add_new tf_plus_icon tb_icon_btn";d.href="#";d.textContent=void 0!==a.new_row?a.new_row:b.label.new_row;if(void 0!==b.values[a.id]){const d=b.values[a.id].slice(),e=q.extend(!0,{},b.values);for(let e=0,f=d.length;e<f;++e)b.values=d[e]||{},c.appendChild(this.builderFields(a,b));b.values=e}else c.appendChild(this.builderFields(a,
b));c.appendChild(d);b.afterRun.push(function(){e.sortable(c,b);d.addEventListener("click",function(d){d.preventDefault();d.stopPropagation();b.is_repeat=!0;const f=e.builderFields(a,b);this.parentNode.insertBefore(f,this);setTimeout(function(){"setting"===b.clicked&&b.setUpEditors();b.callbacks();v.triggerEvent(k,"tb_repeatable_add_new",[f])},5);b.control.preview(c,null,{repeat:!0});b.is_repeat=null})});b.is_repeat=null;return c},builderFields(a,b){const c=k.createElement("div"),d=k.createElement("div"),
e=k.createElement("div"),f=k.createElement("div"),g=k.createElement("ul"),h=k.createElement("li"),m=k.createElement("li"),p=k.createElement("div"),n=k.createElement("div"),u=this;c.className="tb_repeatable_field clearfix";d.className="tb_repeatable_field_top";e.className="row_menu";f.tabIndex="-1";f.className="menu_icon";g.className="tb_down";h.className="tb_duplicate_row";m.className="tb_delete_row tf_close";h.textContent=b.label.duplicate;m.textContent=b.label.delete;p.className="toggle_row";n.className=
"tb_repeatable_field_content";n.appendChild(b.create(a.options));g.appendChild(h);g.appendChild(m);e.appendChild(f);e.appendChild(g);d.appendChild(e);d.appendChild(p);c.appendChild(d);c.appendChild(n);setTimeout(function(){d.addEventListener("click",function(d){d.stopPropagation();d.preventDefault();const e=d.target.classList;if(e.contains("tb_delete_row")){if(confirm(themifyBuilder.i18n.rowDeleteConfirm)){const a=d.target.closest(".tb_row_js_wrapper");u.delete(d.target);b.control.preview(a,null,
{repeat:!0});v.triggerEvent(a,"delete")}}else if(e.contains("tb_duplicate_row")){b.is_repeat=!0;d=q.extend(!0,{},b.values);b.values=l.Forms.serialize(c,!0,!0);const e=u.builderFields(a,b);c.parentNode.insertBefore(e,c.nextElementSibling);b.values=d;setTimeout(function(){"setting"===b.clicked&&b.setUpEditors();b.callbacks();v.triggerEvent(c.parentNode,"duplicate");v.triggerEvent(k,"tb_repeatable_duplicate",[e])},5);b.control.preview(c,null,{repeat:!0});b.is_repeat=null}else e.contains("toggle_row")&&
u.toggle(d.target);e.contains("menu_icon")||l.Utils.hideOnClick(g)})},1500);return c},sortable(a,b){const c=q(a);let d=!1,e={};c.sortable({items:".tb_repeatable_field",handle:".tb_repeatable_field_top",axis:"y",tolerance:"pointer",cursor:"move",cancel:".row_menu",start:_.debounce(function(b,c){if(void 0!==tinyMCE)for(b=a.getElementsByClassName("tb_lb_wp_editor"),c=b.length-1;-1<c;--c){let a=b[c].id;e[a]=tinymce.get(a).getContent();tinyMCE.execCommand("mceRemoveEditor",!1,a)}},300),stop:_.debounce(function(f,
g){if(void 0!==tinyMCE){for(let a in e)tinyMCE.execCommand("mceAddEditor",!1,a),tinymce.get(a).setContent(e[a]);e={}}d&&(g.item.removeClass("collapsed").find(".tb_repeatable_field_content").show(),d=!1);c.find(".tb_state_highlight").remove();b.control.preview(a,null,{repeat:!0});v.triggerEvent(a,"sortable")},300),beforeStart(a,b,e){l.Utils.hideOnClick(e.item[0].getElementsByClassName("tb_down")[0]);c.find(".tb_state_highlight").height(30);e.item[0].classList.contains("collapsed")||(e.item.addClass("collapsed").find(".tb_repeatable_field_content").hide(),
d=!0,c.sortable("refresh"))}})},toggle(a){q(a).closest(".tb_repeatable_field").toggleClass("collapsed").find(".tb_repeatable_field_content").slideToggle()},delete(a){a=a.closest(".tb_repeatable_field");v.triggerEvent(k,"tb_repeatable_delete",[a]);q(a).remove()}},accordion:{expand(a,b,c){a.addEventListener("click",function(a){let d=this.getElementsByClassName("tb_accordion_fields_options")[0];if(void 0===d){d=k.createElement("div");d.style.display="none";d.className="tb_toggleable_fields_options tb_accordion_fields_options";
c.is_repeat=!0;let a=null;const e=this.parentNode.closest(".tb_accordion_fields").id,h=this.getAttribute("data-id");void 0!==c.values[e]&&void 0!==c.values[e][h]&&void 0!==c.values[e][h].val&&(a=q.extend(!0,{},c.values),c.values=c.values[e][h].val);d.appendChild(c.create(b.options));this.appendChild(d);"setting"===c.clicked&&c.setUpEditors();c.callbacks();null!==a&&(c.values=a);c.is_repeat=a=null}else if(d.contains(a.target))return;a.stopPropagation();a.preventDefault();this.classList.contains("tb_closed")?
q(d).slideDown(function(){this.parentNode.classList.remove("tb_closed")}):q(d).slideUp(function(){this.parentNode.classList.add("tb_closed")})})},resetMotion(a,b){if(void 0!==b.values.motion_effects)for(var c in b.values.motion_effects)b.values.motion_effects[c].val={},b.values.motion_effects[c].val[c+"_dir"]="";a=a.parentNode.querySelector("#motion_effects");c=a.getElementsByTagName("select");b=a.getElementsByClassName("tb_position_box_wrapper");a=a.getElementsByClassName("tb_slider_wrapper");for(var d=
c.length-1;-1<d;--d)c[d].selectedIndex=0;for(c=b.length-1;-1<c;--c)b[c].querySelector("input").value="50,50",b[c].querySelector(".tb_position_box_handle").setAttribute("style","left:50%;top:50%;");for(b=a.length-1;-1<b;--b){c=a[b].getElementsByClassName("tb_slider_label_u")[0];d=a[b].getElementsByClassName("ui-slider-handle");let e=a[b].getElementsByTagName("input")[0],f=a[b].getElementsByClassName("tb_slider_label_l")[0];c?(e.value="0,100",d[0].setAttribute("style","left:0%;"),d[1].setAttribute("style",
"left:100%;"),a[b].getElementsByClassName("ui-slider-range")[0].setAttribute("style","left:0%;width:100%;"),f.textContent="0%",c.textContent="100%"):(e.value="5",d[0].setAttribute("style","left:50%;"),f.textContent="5")}},render(a,b){const c=this,d=k.createElement("ul"),e=k.createDocumentFragment(),f=k.createElement("a");d.id=a.id;d.className="tb_toggleable_fields tb_accordion_fields tb_lb_option";"motion_effects"===a.id&&b.values&&b.values.hasOwnProperty("custom_parallax_scroll_speed")&&(b.values.hasOwnProperty("motion_effects")||
(b.values.motion_effects={v:{val:{v_speed:b.values.custom_parallax_scroll_speed,v_dir:""}},h:{val:{}},t:{val:{t_speed:""}},r:{val:{}},s:{val:{}}},delete b.values.custom_parallax_scroll_speed),b.values.hasOwnProperty("custom_parallax_scroll_reverse")?(b.values.motion_effects.v.val.v_dir="down",delete b.values.custom_parallax_scroll_reverse):b.values.motion_effects.v.val.v_dir="up",b.values.hasOwnProperty("custom_parallax_scroll_fade")&&(b.values.motion_effects.t.val.t_speed=b.values.custom_parallax_scroll_speed,
delete b.values.custom_parallax_scroll_fade));const g=b.values[a.id],h=function(e,f){const g=k.createElement("li"),h=k.createElement("input"),m=k.createElement("div");m.textContent=a.options[e].label;m.className="tb_toggleable_fields_title tb_accordion_fields_title tf_plus_icon";h.type="hidden";h.value="";g.className="tb_closed";g.setAttribute("data-id",e);void 0!==f.val&&(h.value=JSON.stringify(f.val));g.appendChild(h);g.appendChild(m);c.expand(g,a.options[e],b);d.appendChild(g)};if(void 0!==g)for(let b in g)void 0!==
a.options[b]&&h(b,g[b]);for(let b in a.options)void 0!==g&&void 0!==g[b]||h(b,a.options[b]);e.appendChild(d);"motion_effects"===a.id&&(f.href="#",f.className="tb_motion_reset_link",f.textContent=b.label.reset_effect,f.addEventListener("click",function(a){a.preventDefault();a.stopPropagation();c.resetMotion(this,b)}),e.appendChild(f));return e}},toggleable_fields:{sort(a,b){const c=q(a);c.sortable({items:">li",axis:"y",placeholder:"tb_state_highlight",forcePlaceholderSize:!0,forceHelperSize:!0,cursor:"move",
tolerance:"pointer",zIndex:9999,cancel:".tb_toggleable_fields_title,.switch-wrapper,.tb_toggleable_fields_options",stop:_.debounce(function(a,e){c.find(".tb_state_highlight").remove();b.control.preview(c[0],null,{repeat:!0});v.triggerEvent(c[0],"sortable")},300),start(a,b){c.sortable("refreshPositions")},beforeStart(a,b,f){c.sortable("refresh")}})},expand(a,b,c){a.addEventListener("click",function(a){if(this.classList.contains("tb_toggleable_field_disabled")||null!==a.target.closest(".switch-wrapper"))null===
a.target.closest(".tb_toggleable_fields_options")&&(a=this.getElementsByClassName("tb_toggleable_fields_options")[0],q(a).slideUp(function(){this.parentNode.classList.add("tb_closed")}));else{let d=this.getElementsByClassName("tb_toggleable_fields_options")[0];if(void 0===d){d=k.createElement("div");d.style.display="none";d.className="tb_toggleable_fields_options";this.appendChild(d);c.is_repeat=!0;let a=this.closest(".tb_toggleable_fields").id,e=null,h=this.getAttribute("data-id");void 0!==c.values[a]&&
void 0!==c.values[a][h]&&void 0!==c.values[a][h].val&&(e=q.extend(!0,{},c.values),c.values=c.values[a][h].val);d.appendChild(c.create(b.options));"setting"===c.clicked&&c.setUpEditors();c.callbacks();null!==e&&(c.values=e);c.is_repeat=e=null}else if(d.contains(a.target))return;a.stopPropagation();a.preventDefault();this.classList.contains("tb_closed")?q(d).slideDown(function(){this.parentNode.classList.remove("tb_closed")}):q(d).slideUp(function(){this.parentNode.classList.add("tb_closed")})}})},
...
h,b));g.apply_all(d,a.querySelector("#"+h.id));a.appendChild(d);return a}},slider:{render(a,b){return b.create(b.getOptions(a))}},custom_css:{render(a,b){a.class="large";a.control=!1;a.help=b.label.custom_css_help;b=b.text.render(a,b);l.Utils.changeOptions(b.querySelector("#"+a.id),a.type);return b}},custom_css_id:{render(a,b){b=b.create([{id:"custom_css_id",type:"text",label:b.label.id_name,help:b.label.id_help,control:!1,"class":"large"}],b);l.Utils.changeOptions(b.querySelector("#custom_css_id"),
a.type);return b}},hidden:{render(a,b){const c=k.createElement("input"),d=b.getStyleVal(a.id);c.type="hidden";!0===b.is_repeat?(c.className=!0===b.is_sort?"tb_lb_sort_child":"tb_lb_option_child",c.dataset.inputId=a.id):(c.className="tb_lb_option",c.id=a.id);void 0!==a.class&&(c.className+=" "+a.class);void 0!==d?c.value=d:void 0!==a.value&&(c.value=a.value);return b.initControl(c,a)}},frame:{render(a,b){a.options=b.static.frame;a.class="tb_frame";a.binding={not_empty:{show:["tb_frame_multi_wrap",
"tb_frame_color"]},empty:{hide:["tb_frame_multi_wrap","tb_frame_color"]}};return b.layout.render(a,b)}},title:{render(a,b){a.class="large";a.control={event:"keyup",control_type:"change",selector:".module-title"};return b.text.render(a,b)}},url:{render(a,b){a.input_type="url";return b.text.render(a,b)}},advacned_link:{render(a,b){return b.create([{id:"link",type:"radio",label:"l",wrap_class:" tb_compact_radios",link_to:!0,binding:{permalink:{show:["open_link"],hide:["custom_link"]},custom:{show:["custom_link"],
hide:["open_link"]},none:{hide:["custom_link","open_link","no_follow"]}}},{id:"custom_link",type:"url",label:"cl"},{id:"open_link",type:"radio",label:"o_l",link_type:!0,control:!1,wrap_class:" tb_compact_radios",binding:{lightbox:{show:["tb_t_m_lightbox"]},regular:{hide:["tb_t_m_lightbox"]},newtab:{hide:["tb_t_m_lightbox"]}}},{type:"multi",wrap_class:"tb_t_m_lightbox",label:"lg",options:[{id:"lightbox_w",type:"range",label:"w",control:!1,units:{px:{min:0,max:1E3},"%":{min:0,max:100}}},{id:"lightbox_h",
type:"range",label:"ht",control:!1,units:{px:{min:0,max:1E3},"%":{min:0,max:100}}}]}])}},button:{render(a,b){const c=k.createElement("button");c.className="builder_button";c.id=a.id;void 0!==a.class&&(c.className+=" "+a.class);c.textContent=a.name;return b.initControl(c,a)}},row_anchor:{render(a,b){a.control=!1;b=b.text.render(a,b);l.Utils.changeOptions(b.querySelector("#"+a.id),a.type);return b}},widget_form:{render(a,b){b=k.createElement("div");b.id=a.id;b.className="module-widget-form-container wp-core-ui tb_lb_option";
return b}},widget_select:{data:null,el:null,cache:[],mediaInit:null,textInit:null,render(a,b){const c=k.createDocumentFragment(),d=k.createElement("div"),e=k.createElement("i"),f=k.createElement("input"),g=k.createElement("div"),h=k.createElement("div");d.id="available-widgets-filter";d.className="selectwrapper";e.className="tb_loading_widgets tf_loader";f.type="text";f.id="widgets-search";f.dataset.validation="not_empty";f.dataset.errorMsg=b.label.widget_validate;f.autocomplete="off";f.placeholder=
b.label.search_widget;g.id="available-widgets";g.className="tf_scrollbar";g.tabIndex=1;h.id=a.id;h.className="tb_lb_option tb_widget_select";this.el=h;d.appendChild(e);d.appendChild(f);g.appendChild(h);c.appendChild(d);c.appendChild(g);const m=this,p=b.values[a.id],n=function(){const c=[],d=function(b,d){for(var e=c.length-1;-1<e;--e)c[e].classList.remove("selected");b.classList.add("selected");e=b.dataset.value;f.value=b.getElementsByClassName("widget-title")[0].textContent;g.style.display="none";
...
m.data[e].d,f.appendChild(n));h.appendChild(f);p===e&&d(f,b.values.instance_widget)}m.search(f,g);e.parentNode.removeChild(e);l.hasChanged=!0};if(null===m.data){q.ajax({type:"POST",url:themifyBuilder.ajaxurl,dataType:"json",data:{action:"tb_get_widget_items",nonce:themifyBuilder.tb_load_nonce},success(a){m.data=a;n()}});for(let a in themifyBuilder.widget_css)r.Themify.LoadCss(themifyBuilder.widget_css[a],themify_vars.version);themifyBuilder.widget_css=null}else setTimeout(n,5);return c},search(a,
b){const c=this;a.addEventListener("focus",this.show.bind(this),{passive:!0});a.addEventListener("blur",function(a){a.relatedTarget&&"available-widgets"===a.relatedTarget.id||(b.style.display="none")},{passive:!0});a.addEventListener("keyup",function(a){c.show();a=this.value.trim();const b=new RegExp(a,"i"),d=c.el.getElementsByClassName("widget-tpl");for(let c=0,e=d.length;c<e;++c)if(""===a)d[c].style.display="block";else{let a=d[c].getElementsByTagName("h3")[0];a=a.textContent||a.innerText;b.test(a)?
d[c].style.display="block":d[c].style.display="none"}},{passive:!0})},show(){this.el.closest("#available-widgets").style.display="block"},hide(){this.el.closest("#available-widgets").style.display="none"},select(a,b,c,d){const e=this,f=q("#instance_widget",x.Lightbox.$lightbox),g=function(g){const h=function(){const h=q(g.form);f.addClass("open").html(h.html());if(c)for(let a in c)h.find('[name="'+a+'"]').val(c[a]);"text"===b?wp.textWidgets&&(e.textInit||(e.textInit=!0,wp.textWidgets.init()),c&&delete wp.textWidgets.widgetControls[c["widget-id"]]):
wp.mediaWidgets&&(e.mediaInit||(wp.mediaWidgets.init(),e.mediaInit=!0),c&&delete wp.mediaWidgets.widgetControls[c["widget-id"]]);q(k).trigger("widget-added",[f]);"text"===b&&ThemifyConstructor.initControl(f.find(".wp-editor-area")[0],{control:{control_type:"wp_editor",type:"refresh"}});if("visual"===l.mode){const b=q.extend(!0,{},d);b.id=f[0].id;f.on("change",":input",function(){!1===l.is_ajax_call&&ThemifyConstructor.control.widget_select(f,b)});a&&ThemifyConstructor.control.widget_select(f,b)}f.removeClass("tb_loading_widgets_form").find("select").wrap('<span class="selectwrapper"/>')},
p=function(a,b){const c=a.length;(function(a,b){v.LoadAsync(a,b,g.v)})(a[b].src,function(){if(a[b].extra&&a[b].extra.after){{var d=a[b].extra.after;let c="";if("object"===typeof d)for(var e in d)d[e]&&(c+=d[e]);""!==c&&(d=k.createElement("script"),e=k.getElementsByTagName("script")[0],d.type="text/javascript",d.text=c,e.parentNode.insertBefore(d,e))}}++b;b<c?p(a,b):h()})};void 0===e.cache[b]?(g.template&&k.body.insertAdjacentHTML("beforeend",g.template),0<g.src.length?p(g.src,0):h()):h()};f.addClass("tb_loading_widgets_form").html('<div class="tf_loader"></div>');
c&&q.each(c,function(a,b){const d=a.match(/.*\[\d\]\[(.*)\]/);q.isArray(d)&&"undefined"!==d[1]&&(delete c[a],c[d[1]]=b)});q.ajax({type:"POST",dataType:"json",url:themifyBuilder.ajaxurl,data:{action:"module_widget_get_form",tb_load_nonce:themifyBuilder.tb_load_nonce,load_class:a,tpl_loaded:1===e.cache[b]?1:0,id_base:b,widget_instance:c},success(a){a&&a.form&&(g(a),e.cache[b]=1)}})}},message:{render(a,b){b=k.createElement("div");void 0!==a.class&&(b.className+=a.class);b.innerHTML=a.comment;return b}},
filters:{render(a,b){const c={hue:{label:b.label.hue,units:{deg:{min:0,max:360}},prop:"hue-rotate"},saturation:{label:b.label.sat,units:{"%":{min:0,max:200}},prop:"saturate"},brightness:{label:b.label.bri,units:{"%":{min:0,max:200}},prop:"brightness"},contrast:{label:b.label.con,units:{"%":{min:0,max:200}},prop:"contrast"},invert:{label:b.label.inv,units:{"%":{min:0,max:100}},prop:"invert"},sepia:{label:b.label.se,units:{"%":{min:0,max:100}},prop:"sepia"},opacity:{label:b.label.op,units:{"%":{min:0,
max:100}},prop:"opacity"},blur:{label:b.label.bl,units:{px:{min:0,max:50}},prop:"blur"}},d=k.createElement("ul"),e=a.id,f=q.extend(!0,{},a);f["class"]="tb_filters_field";f.prop=null;d.className="tb_seperate_items tb_filters_fields";for(let g in c)if(void 0!==c[g]){let h=c[g],l=k.createElement("li"),p=k.createElement("div"),n=k.createElement("span"),q=e+"_"+g;f.id=q;f.units=h.units;f.selector=a.selector;p.className="tb_label";n.className="tb_label_text";n.textContent=h.label;p.appendChild(n);l.appendChild(p);
l.appendChild(b.range.render(f,b));d.appendChild(l);b.styles[q]={prop:h.prop,selector:a.selector}}return d}},help(a){const b=k.createElement("div"),c=k.createElement("div"),d=k.createElement("i");b.className="tb_help";c.className="tb_help_content";d.tabIndex=-1;d.className="icon";c.innerHTML=a;d.appendChild(tb_app.Utils.getIcon("ti-help"));b.appendChild(d);b.appendChild(c);return b},tooltip(a){const b=k.createElement("span");b.className="tb_tooltip_up";b.textContent=a;return b},description(a){const b=
k.createElement("small");b.innerHTML=a;return b},after(a){const b=k.createElement("span");b.className="tb_input_after";b.textContent=a.after;void 0!==a.label&&""!==a.label||void 0===a.help||""===a.help||b.appendChild(this.help(a.help));return b},height:{update(a,b,c){c.checkbox.update(a,c.getStyleVal(a),c)},render(a,b){a.isHeight=!0;const c=k.createDocumentFragment(),d=q.extend(!0,{},a);d.label="ht";d.type="range";d.id=a.id;d.prop="height";d.wrap_class="tb_group_element_"+a.id+"_height tf_inline_b";
d.units={px:{min:0,max:1200},vh:{min:0,max:100},"%":{min:0,max:100},em:{min:0,max:200}};b.range.render(d,b);b.styles[a.id]={prop:"height",selector:a.selector};b.styles[a.id+"_auto_height"]={prop:"height",selector:a.selector};c.appendChild(b.range.render(d,b));c.appendChild(b.checkboxGenerate("checkbox",{id:a.id+"_auto_height",heightID:a.id,type:"checkbox",isHeight:!0,wrap_checkbox:"tf_inline_b",prop:"height",binding:{checked:{hide:["tb_group_element_ht_height"]},not_checked:{show:["tb_group_element_ht_height"]}},
options:[{value:b.label.a_ht,name:"auto"}]}));return c}},toggle_switch:{update(a,b,c){c.checkbox.update(a,c.getStyleVal(a),c)},controlChange(a,b){a.addEventListener("change",function(){this.value=!0===this.checked?b.on.name:void 0!==b.off?b.off.name:"";"visibility"===ThemifyConstructor.clicked&&null!==l.activeModel&&l.Utils.visibilityLabel(v.body[0].querySelector("[data-cid="+l.activeModel.cid+"]"),l.Forms.serialize("tb_options_visibility"))},{passive:!0})},render(a,b){var c=q.extend(!0,{},a);const d=
{},e=k.createElement("div");let f="off",g=b.getStyleVal(a.id);c.control=!1;c["class"]=void 0===c["class"]?"toggle_switch":c["class"]+" toggle_switch";var h=c.options;if(void 0===h||"simple"===h)"simple"===h?h={on:{name:"yes",value:b.label.y},off:{name:"no",value:b.label.no}}:(h={on:{name:"no",value:b.label.s},off:{name:"yes",value:b.label.hi}},void 0===c["default"]&&(c["default"]="on"));void 0===g?("on"===c["default"]&&(f="on"),g="on"===f?h.on.name:void 0!==h.off?h.off.name:""):(!1===g&&(g=""),f=
h.on.name===g?"on":"off");for(var l in h)void 0===c.after&&void 0!==h[l].value&&e.setAttribute("data-"+l,void 0!==b.label[h[l].value]?b.label[h[l].value]:h[l].value),d[l]=h[l];l=Object.keys(h)[0];delete c.binding;delete h[l].value;delete c["default"];c.options=[h[l]];void 0===c.wrap_checkbox&&(c.wrap_checkbox="");c.wrap_checkbox+=" tb_switcher";e.className="switch_label";c=b.checkboxGenerate("checkbox",c);h=c.querySelector(".toggle_switch");h.value=g;h.checked="on"===f;this.controlChange(h,d);h.parentNode.appendChild(e);
b.initControl(h,a);return c}},width:{update(a,b,c){c.checkbox.update(a,c.getStyleVal(a),c)},render(a,b){a.isWidth=!0;var c={id:a.id+"_auto_width",widthID:a.id,type:"checkbox",isWidth:!0,prop:"width",options:[{value:b.label.a_wd,name:"auto"}]};b.styles[a.id+"_auto_width"]={prop:"width",selector:a.selector};c=b.checkboxGenerate("checkbox",c);const d=c.querySelector(".tb_lb_option"),e=c.querySelector("input"),f=q.extend(!0,{},a);e.addEventListener("change",function(b){const c=r.document.getElementsByClassName("tb_group_element_"+
a.id+"_width")[0];b.target.checked?c.classList.add("hide-auto-height"):c.classList.remove("hide-auto-height")});f.label="w";f.type="range";f.id=a.id;f.prop="width";f.wrap_class="tb_group_element_"+a.id+"_width";"auto"===b.values[a.id+"_auto_width"]&&(f.wrap_class+=" hide-auto-height");f.units={px:{min:-2E3,max:2E3},"%":{min:0,max:100,increment:1},em:{min:-20,max:20}};const g=b.create([f]);f.wrap_class="";f.label="mi_wd";f.id="min_"+a.id;f.prop="min-width";const h=b.create([f]);b.styles[f.id]={prop:f.prop,
selector:a.selector};f.label="ma_wd";f.id="max_"+a.id;f.prop="max-width";const k=b.create([f]);b.styles[f.id]={prop:f.prop,selector:a.selector};b.afterRun.push(function(){const a=d.parentNode.closest(".tb_field");a.parentNode.insertBefore(g,a);a.parentNode.insertBefore(k,a.nextSibling);a.parentNode.insertBefore(h,a.nextSibling)});return c}},position:{render(a,b){const c={top:b.label.top,right:b.label.right,bottom:b.label.bottom,left:b.label.left},d=k.createElement("ul"),e=k.createElement("li"),f=
k.createDocumentFragment(),g=k.createDocumentFragment(),h=a.id,l=q.extend(!0,{},a),p=q.extend(!0,{},a);p.options=[];p.option_js=!0;p.id=h+"-type";p.no_toggle=!0;p["default"]="top";p.prop=null;d.className="tb_seperate_items tb_group_element_position";for(let d in c){let e=k.createElement("li"),g=h+"_"+d;p.options.push({value:d,name:b.label[c[d]],icon:'<i class="tic-border-'+d+'"></i>',label_class:"tb_radio_label_borders"});e.className="tb_group_element_"+d;b.styles[g]={prop:d,selector:a.selector};
l.id=g;l.type="range";l.prop="position";l.wrap_class="range_wrapper "+g;l.units={px:{min:-2E3,max:2E3},"%":{min:0,max:100}};e.appendChild(b.range.render(l,b));b.styles[g+"_auto"]={prop:"position",selector:a.selector};e.appendChild(b.checkboxGenerate("checkbox",{id:g+"_auto",is_position:!0,posId:g,prop:d,type:"checkbox",selector:a.selector,options:[{name:"auto",value:b.label.auto}],wrap_checkbox:"tf_inline_b",binding:{checked:{hide:[g]},not_checked:{show:[g]}}}));f.appendChild(e)}e.appendChild(b.radioGenerate("icon_radio",
p,b));d.insertBefore(e,d.childNodes[0]);d.appendChild(f);b.styles[h]={prop:"position",selector:a.selector};l.id=h;l.binding={empty:{hide:["tb_group_element_position"]},absolute:{show:["tb_group_element_position"]},fixed:{show:["tb_group_element_position"]},relative:{hide:["tb_group_element_position"]},"static":{hide:["tb_group_element_position"]}};l.type="select";l.prop="position";l.options={"":"",absolute:b.label.abs,fixed:b.label.fi,relative:b.label.re,"static":b.label.st};l.class="tb_position_field tb_multi_field";
g.appendChild(b.select.render(l,b));g.appendChild(d);return g}}}})(jQuery,Themify,window.top,document);

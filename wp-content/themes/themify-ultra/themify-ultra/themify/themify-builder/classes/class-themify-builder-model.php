...
final class Themify_Builder_Model {
	...
	return array(
		...
		'binding' => array(
			'not_empty' => array( 'hide' => array( 'visible_opt_slider' ) ),
			'scroll' => array( 'show' => array( 'visible_opt_slider' ) ),
		),
	    ),
		array(
    ...
    public static function loadCssModules($key,$url,$v){
	themify_enque_style($key,$url,null,$v);
	Themify_Enqueue_Assets::addLocalization('done',$key,true);
    }
